...
import com.junjun.wherecanifind.R;
...
public class NearMe extends ListActivity {
	...
	private class googleplaces extends AsyncTask<View, Void, String> {
		...
		protected void onPostExecute(String result) {
			if (temp == null) {
				...
				myAdapter = new ArrayAdapter<String>(NearMe.this, R.layout.row_layout, R.id.listText, listTitle);
